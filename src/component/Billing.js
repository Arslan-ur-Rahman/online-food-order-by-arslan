...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Price in PKR</th>
      <th scope="col">Items</th>
      <th scope="col">Total in PKR</th>
    </tr>
  </thead>
<tbody>
{cart.map((v,i)=>{
...
<h2 style={{float:"right",color:"black"}} class="p-3 mb-2 bg-success text-white">Total in PKR: {this.state.total}</h2>
